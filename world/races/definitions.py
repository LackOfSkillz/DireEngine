...
# Racial TDP training-cost modifiers per modern DR canon.
# These remain separate from RACE_STATS and the six-stat balance model used by
# chargen, validation, and race-cap surfaces.
