...
INPUT_PATH = REPO_ROOT / "exports" / "mt506_qwen_capability.txt"
OUTPUT_PATH = REPO_ROOT / "exports" / "mt506_state_renders.md"
...
def main() -> int:
    ...
    with OUTPUT_PATH.open("w", encoding="utf-8") as handle:
        handle.write("# MT-506 State Combination Renders\n\n")
