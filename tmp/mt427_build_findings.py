...
MT427_EXPORT = REPO_ROOT / "exports" / "sample_descriptions_mt427_qwen14b.txt"
FINDINGS_PATH = REPO_ROOT / "exports" / "mt427_findings.md"
ROOM_ORDER = [
    ("demo1", "CRO_500_100"),
    ("demo1", "CRO_500_150"),
...
PRIOR_FAILURE_CHECKS = {
    ...
    "amberwick-lane-western-run-4213-4213-4213": [
        ("zone-id leakage", [r"\bnew_landing\b", r"\bdemo1\b", r"\bcrossingV2\b"]),
    ],
    "crossingV2_192_132": [
...
def main() -> int:
    samples_all = parse_export(MT427_EXPORT)
    ...
    summary = (
        "MT-427 ran a single six-room validation pass after suppressing zone-ID leakage in the prompt assembly, "
        "using Qwen 2.5 14B Instruct at temperature 0.5 on the live LM Studio endpoint. The report below checks "
        "that zone code identifiers no longer appear in the generated prose while preserving the same room-by-room review format."
    )
