...
MT423_EXPORT = REPO_ROOT / "exports" / "sample_descriptions_mt423_qwen14b.txt"
FINDINGS_PATH = REPO_ROOT / "exports" / "mt423_findings.md"
ROOM_ORDER = [
    ("demo1", "CRO_500_100"),
    ("demo1", "CRO_500_150"),
...
def main() -> int:
    samples_all = parse_export(MT423_EXPORT)
    ...
    summary = (
        "MT-423 ran a single six-room validation pass against the installed v4 room-description prompt using "
