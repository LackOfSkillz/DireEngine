...
INPUT_PATH = REPO_ROOT / "exports" / "mt509a_haiku_capability.txt"
OUTPUT_PATH = REPO_ROOT / "exports" / "mt509a_haiku_state_renders.md"
...
def main() -> int:
    ...
    with OUTPUT_PATH.open("w", encoding="utf-8") as handle:
        handle.write("# MT-509a Haiku State Combination Renders\n\n")
