...
MT425_EXPORT = REPO_ROOT / "exports" / "sample_descriptions_mt425_qwen14b_v5.txt"
FINDINGS_PATH = REPO_ROOT / "exports" / "mt425_findings.md"
ROOM_ORDER = [
    ("demo1", "CRO_500_100"),
    ("demo1", "CRO_500_150"),
...
PRIOR_FAILURE_CHECKS = {
    "CRO_500_150": [
        ("room-id leakage", [r"\bCRO_500_100\b"]),
    ],
    "crossingV2_192_132": [
...
def main() -> int:
    samples_all = parse_export(MT425_EXPORT)
    ...
    summary = (
        "MT-425 ran a single six-room validation pass against the condensed v5 room-description prompt using "
        "Qwen 2.5 14B Instruct at temperature 0.5 on the live LM Studio endpoint. The report below captures "
        "the standard rubric metrics and checks the specific regressions called out from MT-419 and MT-421 without iteration."
    )
