...
urlpatterns = [
    ...
    path("builder/api/save-zone/", views.builder_zone_save, name="builder-zone-save"),
    path("builder/api/save-review-graph/", views.builder_review_graph_save, name="builder-review-graph-save"),
    path("builder/api/reload-zone/", views.builder_zone_reload, name="builder-zone-reload"),
    ...
    path("builder/api/review-graph/<str:zone_id>/", views.builder_review_graph_detail, name="builder-review-graph-detail"),
    path("builder/api/review-graph/<str:zone_id>/image/", views.builder_review_graph_image, name="builder-review-graph-image"),
